...
export function buildHandwrittenCardBlock(args: BuildCardArgs): string {
  ...
  return [
    ...
    `<div style="color:#54565b;font-size:11px;font-weight:bold;letter-spacing:1.5px;text-transform:uppercase;margin-bottom:12px;">Handwritten work &middot; Upload to submit</div>`,
    `<h3 style="margin:0 0 10px 0;color:#1a1a1a;font-size:20px;font-weight:normal;line-height:1.3;">Submit your handwritten work</h3>`,
    `<p style="margin:0 0 22px 0;color:#333;font-size:15px;line-height:1.6;">Take clear photos of each page, then upload them here. We&rsquo;ll transcribe your work, save it as a Google Doc in your Drive, and (when your teacher has it turned on) submit the transcript to Canvas for you.</p>`,
    `<a href="${uploadUrl}" style="display:inline-block;padding:12px 26px;background:#7a1e46;color:#ffffff;border-radius:3px;text-decoration:none;font-family:Georgia,'Times New Roman',serif;font-weight:bold;font-size:15px;letter-spacing:0.3px;">Upload handwritten work &rarr;</a>`,
